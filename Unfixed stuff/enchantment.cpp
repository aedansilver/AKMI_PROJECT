...
enum Enchants
{
	...
	ENCHANT_GLOVES_SPELLPOWER			= 44592,
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            switch (action)
            {
				...
				case 9: //Enchant Gloves
					...
					player->ADD_GOSSIP_ITEM(1, "Spell Power", GOSSIP_SENDER_MAIN, 5001);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				...
				case 14: //Remove enchant menu
					...
					player->ADD_GOSSIP_ITEM(1, "Remove enchant on Rings", GOSSIP_SENDER_MAIN, 410);
					player->ADD_GOSSIP_ITEM(1, "<-Back", GOSSIP_SENDER_MAIN, 300);
